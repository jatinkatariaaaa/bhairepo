    ...
    >
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-0 z-10 flex translate-y-[38%] items-end justify-center gap-2 sm:gap-6 md:translate-y-[28%] md:gap-10">
          ...
          >
            <motion.div
              initial={reduce ? {} : { opacity: 0, y: 120, scale: 0.85 }}
        ...
        {/* proof tags */}
        <FloatingTag progress={scrollYProgress} rate={-70 * k} delay={1} className="hidden left-[3%] top-[50%] sm:block md:left-[8%] md:top-[44%]">
          <ProofTag icon="BadgeCheck" label="GSTR-3B" value="Filed · on time" />
        </FloatingTag>
        <FloatingTag progress={scrollYProgress} rate={40 * k} delay={1.15} className="hidden right-[3%] top-[56%] sm:block md:right-[8%] md:top-[42%]">
          <ProofTag icon="IndianRupee" label="Refund credited" value="₹48,200" />
        </FloatingTag>
        <FloatingTag progress={scrollYProgress} rate={90 * k} delay={1.3} className="bottom-[14%] left-[7%] hidden md:block">
          <ProofTag icon="ShieldCheck" label="CA-certified" value="12,000+ returns" />
        </FloatingTag>
        <FloatingTag progress={scrollYProgress} rate={-40 * k} delay={1.45} className="bottom-[18%] right-[7%] hidden md:block">
        ...
        >
          <motion.div style={{ opacity: opacityLede }}>
            <div className="flex items-center gap-2.5 font-mono text-[11px] uppercase tracking-[0.24em] text-muted">
              ...
              <span>CA-led · 100% online · India</span>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              & compliance —{" "}
              <span className="font-serif italic font-normal text-primary">handled.</span>
            </motion.span>
          </motion.h1>
